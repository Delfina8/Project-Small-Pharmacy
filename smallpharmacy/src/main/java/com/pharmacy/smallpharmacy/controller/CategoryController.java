...
public class CategoryController {
	...
	public ResponseEntity <List<Category>> getByManufacturer(@PathVariable String manufacturer){
		return ResponseEntity.ok(categoryRepository.findAllByManufacturerContainingIgnoreCase(manufacturer));
	}
